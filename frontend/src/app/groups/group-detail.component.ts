      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <a (click)="showMembers=true; showTrasactions=false" class=" mb-4 cursor-pointer inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
              Add Members
              <svg aria-hidden="true" class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>

            <p class="text-lg font-normal  text-gray-500 dark:text-gray-400 line-clamp-2">Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools that even influence both web designers and developers.</p>
    ...
    <div class="max-w-2xl mx-auto mb-10">
      ...
      <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px justify-around">
          <li class="mr-2">
            <a  (click)="showTrasactions=true; showMembers=false" class=" cursor-pointer inline-block p-4 hover:text-blue-600 active:border-b-2 border-blue-600 rounded-t-lg  active:text-blue-500 active:border-blue-500" aria-current="page">Transactions</a>
          </li>
          <li class="mr-2">
            <a (click)="showTrasactions=false; showMembers=true" class=" cursor-pointer inline-block p-4 hover:text-blue-600 active:border-b-2 border-blue-600 rounded-t-lg  active:text-blue-500 active:border-blue-500" aria-current="page">Members</a>
          </li>
      ...
      <div class="w-full">
    <app-transaction [transactions]="group.transactions" (remove)="deleteTransaction($event)" *ngIf="showTrasactions" />
        <app-members [members]="group.members" *ngIf="showMembers"/>
    </div>
    </ng-template>
    <div class="max-w-3xl flex items-end justify-end">
