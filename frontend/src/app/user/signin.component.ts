        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" [formGroup]="signinForm" (ngSubmit)="signIn()">
                <div>
                  ...
                  <input type="email" name="email" id="email"
                         ...
                         placeholder="name@company.com" required="true" formControlName="email">
                </div>
                <div>
                  <label for="password"
                ...
                <button type="submit"
                        ...
                        [disabled]="signinForm.status==='INVALID'">Sign in
                </button>
