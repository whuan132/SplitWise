              ...
              <div class="relative w-full max-w-md max-h-full">
                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      <button type="button"
                              ...
                              data-modal-hide="custom-modal" id="close-icon">
                      ...
                      <div class="px-6 py-6 lg:px-8">
                          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Invite a Group Member</h3>
                          <form class="space-y-6" [formGroup]="inviteForm" (ngSubmit)="inviteMember()">
                              <div>
                                  <label for="email"
                              ...
                              <button type="submit"
                                      ...
                                      data-modal-hide="custom-modal">Submit
                              </button>
                          </form>
                      </div>
                  </div>
